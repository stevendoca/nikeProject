...
const MobileWomenMenu = (props) => {
  ...
  return (
    <div className={classes.MobileWomenMenuContainer}>
      <div
        className={classes.MobileWomenMenu}
        onClick={() => {
          setMenu(1);
        }}
      >
      ...
      >
        <div className={classes.mobileMenu}>
          ...
          <div className={classes.MobileMenuHeadline}>Women</div>
      ...
      >
        <div className={classes.mobileMenu}>
          ...
          <div className={classes.MobileMenuHeadline}>Shop By Hand</div>
          <div className={classes.MobileMenuChoiceContainer}>
            <a href="#a" className={classes.MobileMenuChoice}>
              Nike Sportwear
            </a>
...
export default MobileWomenMenu;
